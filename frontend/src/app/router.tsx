...
import { XhsHotKeywordsPage } from "../pages/platforms/xhs/hot-keywords-page";
...
import { SystemStatsPage } from "../pages/system/system-stats-page";
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="/platforms/xhs/hot-keywords" element={<XhsHotKeywordsPage />} />
